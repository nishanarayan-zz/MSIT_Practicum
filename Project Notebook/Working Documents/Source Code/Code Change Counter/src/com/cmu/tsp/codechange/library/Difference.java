/**
 ******************************************************************************
 * Copyright © 2008. CMU.  All Rights Reserved.
 ******************************************************************************
 *
 * Project		  ChangeCounter
 * Team			  TSPi Group 4  
 * File           Difference.java
 * Description    This file contains the data structure that would hold the 
 * 				  difference records.
 * Created by     INCAVA(JAVA-DIFF)
 * Created on     April 20th,2009
 ******************************************************************************
 */
package com.cmu.tsp.codechange.library;
